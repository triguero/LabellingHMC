 ...
 */
  ...
  /**
   * It returns a String with the attribute information in WEKA format!
   * @return an String with the attribute information.
   */
	...
	public String toStringHML_WEKA(){
		String aux = "@attribute " + name;
	    ...
	    if(nominalValues.elementAt(0).equals("root")){  //Soy DAG dataset! de dso en dos!
	    	 for (int i=0; i<nominalValues.size()-1; i++){
			        if (i == nominalValues.size() - 2) ending = "";
			        aux += (String)nominalValues.elementAt(i) +"/"+(String)nominalValues.elementAt(i+1)+ ending;
			    }
