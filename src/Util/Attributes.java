 ...
 */
  ...
  static public String lineClasses=""; // for DAGs Multilabel.
 ...
 */
  ...
  public static void setUndefined(Vector nodefinido){
	  undefinedAttr = new Vector(nodefinido);
	  
  }
  
  public static void removeUndefined(){
	  undefinedAttr = new Vector();
   ...
   * @return
   */
  public static boolean restoreAttribute(int whichAtt, int pos, int tipo){
	    Attribute atToDel=null;
	    if ( (whichAtt >=  inputAttr.size() || whichAtt < 0)) return false;
	   	   
	   	    
        atToDel =  (Attribute) undefinedAttr.elementAt(whichAtt);
    	atToDel.setDirectionAttribute(tipo);
    	 
	    inputAttr.insertElementAt(atToDel,pos);
